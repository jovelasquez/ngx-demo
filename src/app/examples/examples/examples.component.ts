...
export class ExamplesComponent implements OnInit, OnDestroy {
  ...
  examples = [
    { link: 'todos', label: 'lottonini.examples.menu.todos' },
    { link: 'stock-market', label: 'lottonini.examples.menu.stocks' },
    { link: 'theming', label: 'lottonini.examples.menu.theming' },
    { link: 'crud', label: 'lottonini.examples.menu.crud' },
    { link: 'form', label: 'lottonini.examples.menu.form' },
    { link: 'authenticated', label: 'lottonini.examples.menu.auth', auth: true }
  ];

...
export class AppComponent implements OnInit, OnDestroy {
  ...
  languages = ['es'];
  navigation = [
    { link: 'about', label: 'lottonini.menu.about' },
    { link: 'features', label: 'lottonini.menu.features' },
    { link: 'examples', label: 'lottonini.menu.examples' }
  ];
  navigationSideMenu = [
    ...this.navigation,
    { link: 'settings', label: 'lottonini.menu.settings' }
  ];

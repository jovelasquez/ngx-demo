...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<lottonini-big-input-action></lottonini-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<lottonini-big-input-action [disabled]="true"></lottonini-big-input-action>';
    fixture = createHostComponent(template);
    expect(getButton().nativeElement.disabled).toBeTruthy();
  });

  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template = `<lottonini-big-input-action fontSet="fas" fontIcon="fa-trash"></lottonini-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template = `<lottonini-big-input-action label="delete"></lottonini-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template = `<lottonini-big-input-action (action)="actionHandler()"></lottonini-big-input-action>`;
    fixture = createHostComponent(template);
